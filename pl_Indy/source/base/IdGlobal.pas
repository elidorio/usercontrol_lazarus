...
type
  ...
  ['{FA87FAE5-E3E3-4632-8FCA-2FB786848655}']
    function GetByteCount(AChars: TIdWideChars): Integer; overload;
    function GetByteCount(AChars: TIdWideChars; ACharIndex, ACharCount: Integer): Integer; overload;
    {$IFNDEF DOTNET}
    function GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer; overload;
    {$ENDIF}
    ...
    function GetBytes(AChars: TIdWideChars): TIdBytes; overload;
    function GetBytes(AChars: TIdWideChars; ACharIndex, ACharCount: Integer): TIdBytes; overload;
    function GetBytes(AChars: TIdWideChars; ACharIndex, ACharCount: Integer; var VBytes: TIdBytes; AByteIndex: Integer): Integer; overload;
    {$IFNDEF DOTNET}
    function GetBytes(AChars: PIdWideChar; ACharCount: Integer): TIdBytes; overload;
    function GetBytes(AChars: PIdWideChar; ACharCount: Integer; var VBytes: TIdBytes; AByteIndex: Integer): Integer; overload;
    function GetBytes(AChars: PIdWideChar; ACharCount: Integer; ABytes: PByte; AByteCount: Integer): Integer; overload;
    {$ENDIF}
    ...
    function GetCharCount(ABytes: TIdBytes): Integer; overload;
    function GetCharCount(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): Integer; overload;
    {$IFNDEF DOTNET}
    function GetCharCount(ABytes: PByte; AByteCount: Integer): Integer; overload;
    {$ENDIF}
    function GetChars(ABytes: TIdBytes): TIdWideChars; overload;
    function GetChars(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): TIdWideChars; overload;
    function GetChars(ABytes: TIdBytes; AByteIndex, AByteCount: Integer; var VChars: TIdWideChars; ACharIndex: Integer): Integer; overload;
    {$IFNDEF DOTNET}
    function GetChars(ABytes: PByte; AByteCount: Integer): TIdWideChars; overload;
    function GetChars(ABytes: PByte; AByteCount: Integer; var VChars: TIdWideChars; ACharIndex: Integer): Integer; overload;
    function GetChars(ABytes: PByte; AByteCount: Integer; AChars: PIdWideChar; ACharCount: Integer): Integer; overload;
    {$ENDIF}
    ...
    function GetString(ABytes: TIdBytes): TIdUnicodeString; overload;
    function GetString(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): TIdUnicodeString; overload;
    {$IFNDEF DOTNET}
    function GetString(ABytes: PByte; AByteCount: Integer): TIdUnicodeString; overload;
    {$ENDIF}
 ...
 // function IndyTextEncoding(ACodepage: Word): IIdTextEncoding; overload;     // 9999
...
{$I IdStream_int.inc} //======================= 9999 for CodeTyphon Studio
...
procedure WriteTIdBytesToStream(const AStream: TStream; ABytes: TIdBytes;
...
function ByteIndex(const AByte: Byte; ABytes: TIdBytes; const AStartIndex: Integer = 0): Integer;
function ByteIdxInSet(ABytes: TIdBytes; const AIndex: Integer; const ASet: TIdBytes): Integer;
function ByteIsInSet(ABytes: TIdBytes; const AIndex: Integer; const ASet: TIdBytes): Boolean;
function ByteIsInEOL(ABytes: TIdBytes; const AIndex: Integer): Boolean;
...
function IsASCII(ABytes: TIdBytes): Boolean; overload;
function IsASCIILDH(const AByte: Byte): Boolean; overload;
function IsASCIILDH(ABytes: TIdBytes): Boolean; overload;
...
function StartsWithACE(ABytes: TIdBytes): Boolean;
...
uses
  ...
  {$ENDIF}
  IdResourceStrings; // 9999
  
{$I IdStream_imp.inc} //======================= 9999 for CodeTyphon Studio 
...
function TIdDotNetEncoding.GetByteCount(AChars: TIdWideChars): Integer;
begin
  Result := FEncoding.GetByteCount(AChars);
end;

function TIdDotNetEncoding.GetByteCount(AChars: TIdWideChars; ACharIndex, ACharCount: Integer): Integer;
begin
...
function TIdDotNetEncoding.GetBytes(AChars: TIdWideChars): TIdBytes;
begin
  Result := FEncoding.GetBytes(AChars);
end;

function TIdDotNetEncoding.GetBytes(AChars: TIdWideChars; ACharIndex, ACharCount: Integer): TIdBytes;
begin
  Result := FEncoding.GetBytes(AChars, ACharIndex, ACharCount);
end;

function TIdDotNetEncoding.GetBytes(AChars: TIdWideChars; ACharIndex, ACharCount: Integer; var VBytes: TIdBytes; AByteIndex: Integer): Integer;
begin
...
function TIdDotNetEncoding.GetCharCount(ABytes: TIdBytes): Integer;
begin
  Result := FEncoding.GetCharCount(ABytes);
end;

function TIdDotNetEncoding.GetCharCount(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): Integer;
begin
  Result := FEncoding.GetCharCount(ABytes, AByteIndex, AByteCount);
end;

function TIdDotNetEncoding.GetChars(ABytes: TIdBytes): TIdWideChars;
begin
  Result := FEncoding.GetChars(ABytes);
end;

function TIdDotNetEncoding.GetChars(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): TIdWideChars;
begin
  Result := FEncoding.GetChars(ABytes, AByteIndex, AByteCount);
end;

function TIdDotNetEncoding.GetChars(ABytes: TIdBytes; AByteIndex, AByteCount: Integer; var VChars: TIdWideChars; ACharIndex: Integer): Integer;
begin
...
function TIdDotNetEncoding.GetString(ABytes: TIdBytes): TIdUnicodeString;
begin
  Result := FEncoding.GetString(ABytes);
end;

function TIdDotNetEncoding.GetString(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): TIdUnicodeString;
begin
...
type
  ...
  public
    ...
    constructor Create(CodePage, MBToWCharFlags, WCharToMBFlags: Integer); overload; virtual;
      {$ENDIF}
    {$ENDIF}
    function GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer; overload; override;
    function GetBytes(AChars: PIdWideChar; ACharCount: Integer; ABytes: PByte; AByteCount: Integer): Integer; overload; override;
    function GetCharCount(ABytes: PByte; AByteCount: Integer): Integer; overload; override;
    function GetChars(ABytes: PByte; AByteCount: Integer; AChars: PIdWideChar; ACharCount: Integer): Integer; overload; override;
...
function ValidateChars(AChars: TIdWideChars; ACharIndex, ACharCount: Integer): PIdWideChar;
var
  Len: Integer;
begin
  Len := Length(AChars);
...
function ValidateBytes(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): PByte; overload;
var
  Len: Integer;
begin
  Len := Length(ABytes);
...
function ValidateBytes(ABytes: TIdBytes; AByteIndex, AByteCount, ANeeded: Integer): PByte; overload;
var
  Len: Integer;
begin
  Len := Length(ABytes);
...
function TIdTextEncodingBase.GetByteCount(AChars: TIdWideChars): Integer;
begin
...
function TIdTextEncodingBase.GetByteCount(AChars: TIdWideChars;
...
function TIdTextEncodingBase.GetBytes(AChars: TIdWideChars): TIdBytes;
begin
  if AChars <> nil then begin
...
function TIdTextEncodingBase.GetBytes(AChars: TIdWideChars;
...
function TIdTextEncodingBase.GetBytes(AChars: PIdWideChar; ACharCount: Integer): TIdBytes;
var
  Len: Integer;
begin
  Result := nil;
...
function TIdTextEncodingBase.GetBytes(AChars: PIdWideChar; ACharCount: Integer;
...
function TIdTextEncodingBase.GetCharCount(ABytes: TIdBytes): Integer;
begin
...
function TIdTextEncodingBase.GetCharCount(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): Integer;
var
  LBytes: PByte;
begin
...
function TIdTextEncodingBase.GetChars(ABytes: TIdBytes): TIdWideChars;
begin
  if ABytes <> nil then begin
...
function TIdTextEncodingBase.GetChars(ABytes: TIdBytes; AByteIndex, AByteCount: Integer): TIdWideChars;
var
  Len: Integer;
begin
  Result := nil;
...
function TIdTextEncodingBase.GetChars(ABytes: TIdBytes;
...
function TIdTextEncodingBase.GetChars(ABytes: PByte; AByteCount: Integer): TIdWideChars;
var
  Len: Integer;
begin
...
function TIdTextEncodingBase.GetChars(ABytes: PByte; AByteCount: Integer;
...
function TIdTextEncodingBase.GetString(ABytes: TIdBytes): TIdUnicodeString;
begin
  if ABytes <> nil then begin
...
function TIdTextEncodingBase.GetString(ABytes: TIdBytes;
...
function TIdTextEncodingBase.GetString(ABytes: PByte; AByteCount: Integer): TIdUnicodeString;
var
  Len: Integer;
begin
  Result := '';
...
function TIdMBCSEncoding.GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer;
{$IFDEF USE_ICONV}
var
...
function TIdMBCSEncoding.GetBytes(AChars: PIdWideChar; ACharCount: Integer; ABytes: PByte;
...
function TIdMBCSEncoding.GetCharCount(ABytes: PByte; AByteCount: Integer): Integer;
{$IFDEF USE_ICONV}
var
...
function TIdMBCSEncoding.GetChars(ABytes: PByte; AByteCount: Integer; AChars: PWideChar;
...
function TIdUTF7Encoding.GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer;
begin
  Result := inherited GetByteCount(AChars, ACharCount);
end;

function TIdUTF7Encoding.GetBytes(AChars: PIdWideChar; ACharCount: Integer;
  ABytes: PByte; AByteCount: Integer): Integer;
begin
  Result := inherited GetBytes(AChars, ACharCount, ABytes, AByteCount);
end;

function TIdUTF7Encoding.GetCharCount(ABytes: PByte; AByteCount: Integer): Integer;
begin
  Result := inherited GetCharCount(ABytes, AByteCount);
end;

function TIdUTF7Encoding.GetChars(ABytes: PByte; AByteCount: Integer;
...
function TIdUTF16LittleEndianEncoding.GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer;
begin
  // TODO: verify UTF-16 sequences
  Result := ACharCount * SizeOf(WideChar);
end;

function TIdUTF16LittleEndianEncoding.GetBytes(AChars: PIdWideChar; ACharCount: Integer;
  ABytes: PByte; AByteCount: Integer): Integer;
{$IFDEF ENDIAN_BIG}
var
  I: Integer;
...
function TIdUTF16LittleEndianEncoding.GetCharCount(ABytes: PByte; AByteCount: Integer): Integer;
begin
  // TODO: verify UTF-16 sequences
  Result := AByteCount div SizeOf(WideChar);
end;

function TIdUTF16LittleEndianEncoding.GetChars(ABytes: PByte; AByteCount: Integer;
  AChars: PIdWideChar; ACharCount: Integer): Integer;
{$IFDEF ENDIAN_BIG}
var
...
function TIdUTF16BigEndianEncoding.GetBytes(AChars: PIdWideChar; ACharCount: Integer;
  ABytes: PByte; AByteCount: Integer): Integer;
{$IFDEF ENDIAN_LITTLE}
var
  I: Integer;
...
function TIdUTF16BigEndianEncoding.GetChars(ABytes: PByte; AByteCount: Integer;
  AChars: PIdWideChar; ACharCount: Integer): Integer;
{$IFDEF ENDIAN_LITTLE}
var
  P1, P2: PByte;
...
function TIdVCLEncoding.GetByteCount(AChars: PIdWideChar; ACharCount: Integer): Integer;
begin
  Result := TEncodingAccess(FEncoding).IndyGetByteCount(AChars, ACharCount);
end;

function TIdVCLEncoding.GetBytes(AChars: PIdWideChar; ACharCount: Integer;
  ABytes: PByte; AByteCount: Integer): Integer;
begin
  Result := TEncodingAccess(FEncoding).IndyGetBytes(AChars, ACharCount, ABytes, AByteCount);
end;

function TIdVCLEncoding.GetCharCount(ABytes: PByte; AByteCount: Integer): Integer;
begin
  Result := TEncodingAccess(FEncoding).IndyGetCharCount(ABytes, AByteCount);
end;

function TIdVCLEncoding.GetChars(ABytes: PByte; AByteCount: Integer;
  AChars: PIdWideChar; ACharCount: Integer): Integer;
begin
...
{ ===================== 9999
function IndyTextEncoding(ACodepage: string): IIdTextEncoding;   // 9999
begin
  case ACodepage of
    20127, 1252, 437:
    ...
    Result := TIdMBCSEncoding.Create(ACodepage); // 9999
  end;
end;
}
...
function IsASCIILDH(ABytes: TIdBytes): Boolean;
var
  i: Integer;
begin
...
function IsASCII(ABytes: TIdBytes): Boolean;
var
  i: Integer;
begin
  for i := 0 to Length(ABytes) -1 do begin
